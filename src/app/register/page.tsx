    ...
    <div className="flex flex-1 items-center justify-center px-4 py-12">
      <Card className="w-full max-w-sm shadow-sm border border-gray-100/80">
        <CardHeader className="flex flex-col items-center pt-10 pb-0">
          ...
          <CardDescription className="text-gray-400">Guarda tus recetas favoritas</CardDescription>
        </CardHeader>
        <CardContent className="px-8 pb-10 pt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="name" className="text-xs font-medium text-gray-500 tracking-wide uppercase">
                Nombre
              </label>
          ...
          <p className="text-center text-sm text-gray-500">
            ¿Ya tienes cuenta?{" "}
            <Link href="/login" className="text-gray-900 font-medium underline underline-offset-2 hover:text-gray-600 transition-colors">
              Inicia sesión
            </Link>
          </p>
        </CardContent>
